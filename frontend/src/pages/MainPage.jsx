...
function MainPage() {
  ...
  return (
    <div className="min-h-screen bg-blue-200">
      {/* Hero Section */}
      <div className="relative w-full p-4 md:h-64 bg-gradient-to-r from-blue-800 via-blue-600 to-blue-400 rounded-b-3xl shadow-lg flex flex-col-reverse md:flex-row items-center px-10 md:px-20">
        {/* Left - User Details */}
        ...
        <div className="w-1/3 flex justify-center md:justify-end">
          <img
            src={user.avatar}
            alt="Professor"
            className="w-60 h-60 md:w-54 md:h-54 lg:w-60 lg:h-60 rounded-full border-4 border-white shadow-lg object-cover"
          />
        </div>
      </div>
